...
import { LayoutDashboard, BookOpen, ClipboardCheck, TrendingUp, User, LogOut, GraduationCap } from "lucide-react";
...
const NAV = [
  ...
  { to: "/mock-exam", label: "Mock Exam", icon: ClipboardCheck },
...
export function AppShell({ children }: { children: ReactNode }) {
  ...
  return (
    <div className="min-h-screen bg-background flex">
      ...
      {/* Mobile bottom tabs */}
      <nav className="md:hidden fixed bottom-0 inset-x-0 z-30 bg-sidebar text-sidebar-foreground border-t border-sidebar-border">
